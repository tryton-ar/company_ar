...
class Company:
    ...
    def get_account_invoice_install_dir(self):
        basepath = __file__
        return os.path.dirname(os.path.abspath(basepath))

    def get_cache_dir(self):
        return os.path.join(self.get_account_invoice_install_dir(), 'cache')
    ...
    def pyafipws_authenticate(self, service='wsfe', force=False):
        ...
        auth = afip_auth.authenticate(service, certificate, private_key,
            wsdl=WSAA_URL, force=force, cache=self.get_cache_dir())
